...
public class LottoDatumUtilDemo {
	...
	public static void main(String[] args) throws IllegalArgumentException{
		...
		for(GregorianCalendar abgabeDatum : abgabeDaten) {
			naechsterZiehungstag = LottoDatumUtil.ersterZiehungstag(abgabeDatum.getTime(), true,
					false, 18, 19);
		...
		for(GregorianCalendar abgabeDatum : abgabeDaten) {
			naechsterZiehungstag = LottoDatumUtil.ersterZiehungstag(abgabeDatum.getTime(), false,
					true, 18, 19);
			System.out.println(sdf1.format(abgabeDatum.getTime()) + " -> " + sdf2.format(naechsterZiehungstag));
		}
